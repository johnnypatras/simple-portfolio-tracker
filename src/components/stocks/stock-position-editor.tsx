            ...
            >
              ...
              <div>
                <CurrencyAmountInput
                  ...
                  value={{
                    amountStr: costEdits[brokerId] ?? "",
                    currency: costCurrency[brokerId] ?? "EUR",
                  }}
                  onChange={(v) => {
                    ...
                    if (v.amountStr !== (costEdits[brokerId] ?? "")) {
                      setCostEdits((prev) => ({ ...prev, [brokerId]: v.amountStr }));
                      setCostDirty((prev) => ({ ...prev, [brokerId]: true }));
                    }
                    if (v.currency !== (costCurrency[brokerId] ?? "EUR")) {
                      setCostCurrency((prev) => ({ ...prev, [brokerId]: v.currency }));
                    }
                  }}
                  defaultCurrency="EUR"
                  disabled={isSaving}
